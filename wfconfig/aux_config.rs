use crate::strategy::{FilterSniList, Strategy};
use crate::weak_range::WeakRange;
    ...
    fn default() -> Self {
        Self {
            ...
            strategies: vec![Some(Strategy {
                method: crate::strategy::Strategies::FRAGTLS,
                base_index: 3,
                add_sni: true,
                add_host: false,
                subtract: false,
                ...
                filter_protocol: Some(crate::NetworkProtocol::TCP),
